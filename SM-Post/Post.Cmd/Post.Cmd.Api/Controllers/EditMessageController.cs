...
public class EditMessageController : ControllerBase
{
    ...
    public EditMessageController(ICommandDispatcher commandDispatacher, ILogger<EditMessageController> logger)
    {
    ...
    public async Task<ActionResult> EditMessageAsync(Guid id, EditMessageCommand command)
    {
        ...
        {
            const string SAFE_ERROR_MESSAGE = "Error while processing request to edit the message to a post!";
